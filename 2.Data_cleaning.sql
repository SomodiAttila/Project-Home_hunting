...
SET CONDITION =
    CASE
    WHEN CONDITION = 'új építésû' THEN 'New'
    WHEN CONDITION = 'jó állapotú' THEN 'Good'
    WHEN CONDITION = 'újszerû' THEN 'Novel'
...
SET HEAT =
    ...
    WHEN HEAT = 'távfûtés'                     THEN 'District'
    WHEN HEAT = 'távfûtés egyedi méréssel'     THEN 'District with metering'
    WHEN HEAT = 'elektromos'                   THEN 'Electric'
    WHEN HEAT = 'fan-coil'                     THEN 'Fan-coil'
    WHEN HEAT = 'mennyezeti hûtés-fûtés'       THEN 'Ceiling'
    WHEN HEAT = 'hõszivattyú'                  THEN 'Heat pump'
    WHEN HEAT = 'egyéb'                        THEN 'Other'
    WHEN HEAT = 'padlófûtés'                   THEN 'Floor'
    WHEN HEAT = 'falfûtés'                     THEN 'Wall'
    ...
    WHEN HEAT = 'vegyes tüzelésû kazán'        THEN 'Mixed fuel boiler'
...
SET YEAR = 
    CASE
    WHEN YEAR = '1950 elõtt'          THEN 'Before 1950'
